...
try:
    with open('CountingHallPos copy 2', 'rb') as f:
...
def save_shapes():
    """Save shapes to file"""
    with open('CountingHallPos copy 2', 'wb') as f:
...
# Main loop
while True:
    img = cv2.imread('CountingZoneHall_5.png')
    
    if img is None:
        print("Error: Could not load image 'CountingZoneHall_5.png'")
        break
